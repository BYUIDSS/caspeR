...
#' report being scrapped has two tables see \code{\link{get_two_tables_2020}}. The
#' arguments for this function are the same as the outputs for \code{\link{get_table_info_old
