...
#'
#' This function is for pdf reports from 2020 that have two tables in the pdf
#' (Jan 2020 reports have one table but Feb 2020 reports have two). If the report being
#' scrapped has one table see \code{get_1_table_info_2020()}. The arguments for this
#' function have the same arguments as \code{get_table_info_old()} other than the
#' Report_Period and the Comparision_Group. User should also be aware that all NA's are
